...
export default function Layout({
  ...
  return (
    <SidebarProvider className="w-full" style={{ "--sidebar-width": "244px" } as React.CSSProperties}>
        ...
        <div className="min-w-0 flex flex-col h-full">
          <Header>
            <div className="searchbar max-w-md hidden md:flex cursor-pointer">
              ...
              <kbd className="ml-auto rounded border border-line bg-surface px-1.5 text-[11px]">⌘K</kbd>
            </div>
            <div className="ms-auto flex items-center space-x-2">
              <button className="icon-btn"><Languages className="w-4 h-4" /></button>
