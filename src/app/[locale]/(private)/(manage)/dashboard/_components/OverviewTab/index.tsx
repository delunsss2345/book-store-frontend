...
import { revenueChartConfig, type RevenuePoint } from "../data/dashboard.data";
        ...
        {[
          ...
          <div key={metric.title} className="stat">
            ...
            <div className="stat-v">
              {metric.value}
              {metric.unit && (
                <span className="text-[17px] text-ink-3">{metric.unit}</span>
              )}
            </div>
        ...
        <div className="card p-5">
          ...
          <div className="mt-4 space-y-3">
            {[
              ...
              <div
                key={item.sku}
                className="flex items-start gap-3 rounded-xl border border-line bg-paper px-3 py-2.5"
              >
