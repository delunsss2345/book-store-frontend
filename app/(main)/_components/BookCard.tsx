...
> = {
  default: {
    ...
    badgeWrap: "mt-6",
    badge: "inline-flex items-center justify-center rounded-sm border border-neutral-300 text-[12px] tracking-widest text-neutral-700",
    title: "mt-5 font-serif text-[22px] leading-[1.15] tracking-tight text-neutral-900",
    subtitle: "mt-1 text-[20px] leading-[1.15] tracking-tight text-neutral-700",
    price: "mt-6 text-[15px] font-semibold tracking-widest text-neutral-600",
  },
  compact: {
    wrap: "w-full ",
    ...
    img: "h-full w-full object-contain",
    badgeWrap: "mt-5",
    badge: "inline-flex items-center justify-center rounded-sm border border-neutral-300 text-[11px] tracking-widest text-neutral-700",
    title: "mt-4 font-serif text-[18px] leading-[1.15] tracking-tight text-neutral-900",
    subtitle: "mt-1 text-[17px] leading-[1.15] tracking-tight text-neutral-700",
    price: "mt-5 text-[14px] font-semibold tracking-widest text-neutral-600",
  },
};
