...
const books = [
    ...
    {
        title: "Ralph Gibson.",
        subtitle: "Photographs 1960–2024",
        price: 1500,
        badge: "NEW",
        imageUrl:
    ...
    },
    {
        ...
        subtitle: "On Fashion Photography",
        price: 4500,
        badge: "",
        imageUrl:
            "https://images.unsplash.com/photo-1524995997946-a1c2e315a42f?auto=format&fit=crop&w=600&q=80",
    ...
    },
    {
        ...
        subtitle: "L'Arc de Triomphe, Wrapped",
        price: 1800,
        badge: "NEW",
        imageUrl:
            "https://images.unsplash.com/photo-1544947950-fa07a98d237f?auto=format&fit=crop&w=600&q=80",
...
const themes = [
    { label: "Art Editions", count: 89 },
    { label: "Photography", count: 64 },
    { label: "SUMO", count: 23 },
    { label: "Collector's Editions", count: 45 },
    { label: "Fine Art Prints", count: 31 },
    { label: "Fashion", count: 18 },
    { label: "Film", count: 12 },
...
const priceRanges = [
    ...
    "US$ 3,000 to US$ 5,000",
    "More than US$ 5,000",
];

const languages = [
    { label: "English", count: 210 },
    { label: "German", count: 155 },
    { label: "French", count: 142 },
    { label: "Multilingual", count: 98 },
    { label: "Spanish", count: 47 },
    { label: "Italian", count: 33 },
];
    ...
    return (
        <div className="mx-auto w-full max-w-[var(--container-main)] px-6 pb-16">
            ...
            <div className="flex items-center gap-2 py-4 text-xs text-zinc-500">
                ...
                <span>/</span>
                <span className="text-zinc-700">Limited Editions (291 Items)</span>
            </div>
